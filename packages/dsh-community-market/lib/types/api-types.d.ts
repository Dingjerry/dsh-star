...
export type MarketCatalogErrorCode = 'catalog-timeout' | 'catalog-invalid-response' | 'catalog-unavailable';
...
export type MarketSourceMutation = {
    readonly action: 'add-builtin';
    readonly key: string;
} | {
    readonly action: 'add-standard';
